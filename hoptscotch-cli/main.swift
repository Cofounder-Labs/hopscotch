...
func printUsage() {
    print("""
    Usage:
      hopscotch-cli act <x> <y> <width> <height> <targetBundleID>
      hopscotch-cli observe <x> <y> <width> <height>
      hopscotch-cli mode <act|observe>
    
    Examples:
      hopscotch-cli act 100 200 300 100 com.apple.finder
      hopscotch-cli observe 500 600 200 150
      hopscotch-cli mode act
    """)
}
